...
export async function viewBookings(req, res) {
    ...
    try {
        ...
        if (!foundCenterSport) {
            return response_400(
                res,
                "The sport is not offered at the selected center."
            );
        }
...
export async function createBooking(req, res) {
    ...
    try {
        ...
        // If the number of conflicting bookings reaches maxBookings, the court is fully booked
        if (conflictingBookings.length >= court.maxBookings) {
